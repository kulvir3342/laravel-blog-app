...
<h2 class="text-2xl text-gray-600 font-bold mt-16">User Registration</h2>
...
@endif --}}
    ...
    <form action="{{route('user.register')}}" method="POST" class="w-[70%] mt-10">
        @csrf
        <div class="flex flex-col">
            <label for="name" class="text-xl font-medium text-gray-600">User Name</label>
            <input type="text" value="{{old('name')}}" class="border-2 w-full rounded-lg mt-3 h-10 pl-3 focus:outline-blue-600" name="name" id="name">
            @error('name')
        ...
        <div class="mt-7">
            <label for="password_confirmation" class="text-xl font-medium text-gray-600">Confirm Password</label>
            <input type="password" class="border-2 w-full rounded-lg mt-3 h-10 pl-3 focus:outline-blue-600" name="password_confirmation" id="password_confirmation">
